...
function generateMarkdown(data) {
   ...
   if (data.repoName !== "" && data.username !== "")
      repoBadgelink = `[![Generic badge](https://img.shields.io/badge/GitHub-Repo-<COLOR>.svg)](https://github.com/${data.username}/${data.repoName})`;
